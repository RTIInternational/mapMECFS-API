...
#User will need to retrieve their API key from their mapMECFS user profile page
#User will enter their personal API key in place of the text "API-KEY-HERE" in the following commands
#####################################
...
curl "https://www.mapmecfs.org/api/3/action/package_list" -H "Authorization: API-KEY-HERE"
...
curl "https://www.mapmecfs.org/api/3/action/current_package_list_with_resources" -H "Authorization: API-KEY-HERE"
...
curl "https://www.mapmecfs.org/api/3/action/tag_list" -H "Authorization: API-KEY-HERE"
...
curl "https://www.mapmecfs.org/api/3/action/package_show?id=me-cfs-and-ifs-case-control-rna-expression-study-on-monozygotic-twins-gse16059" -H "Authorization: API-KEY-HERE"
...
curl "https://www.mapmecfs.org/api/3/action/package_search?fq=tags:case-control" -H "Authorization: API-KEY-HERE"
